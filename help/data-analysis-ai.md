...
| **Out-of-scope prompt detection** | If you submit a prompt that is out of scope, such as "export this project," Data Insights Agent responds by letting you know that the question is out of scope. | 
...
| **Multi-turn** | Data Insights Agent responds to a prompt with the context from any prior prompts, allowing users to update visualizations and ask follow-up questions. Example: <ul><li>Prompt 1: *Trend events from March.*</li><li>Prompt 2: *Show me the data from March to April instead*</li></ul> |
