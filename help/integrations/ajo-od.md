...
After a connection is created, you can create one or more [Data Views](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/create-dataview.html?lang=en) to configure the desired dimensions and metrics available in Customer Journey Analytics.
