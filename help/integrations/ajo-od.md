...
Decision Management is part of and integrated with Adobe Journey Optimizer (AJO). It can also be used independently of journeys and campaigns defined in AJO, using its rich [API](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioning/api-reference/getting-started.html?lang=en) support.

You can import data generated by Decision Management to perform advanced analysis in Customer Journey Analytics (CJA) by performing the following steps:
