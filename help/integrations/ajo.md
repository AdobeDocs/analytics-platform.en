...
You can import data generated by Journey Optimizer to perform advanced analysis in Customer Journey Analytics. You can do this automatically. If needed, you can make additional, manual customizations to the datasets, dimensions, or metrics that are available in your data views that you use for both Journey Optimizer and Customer Journey Analytics. 

## Automatically configure Journey Optimizer integration

[!BADGE Beta]

Journey Optimizer supports using Customer Journey Analytics as the reporting engine. See [Get started with new Reporting interface](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/channel-report/report-gs-cja) in the Journey Optimizer documentation.
...
The data view has the name **AJO Enable Dataview (*sandbox name*)**.
...
- In the **Components** tab:
  ...
  - All metrics and dimensions that have **[!UICONTROL (AJO)]** appended to their name are automatically added as part of the automatic configuration. 
  ...
  - All automatically added metrics and dimensions do have context label named **[!UICONTROL :*name_of_metric_or_dimension*]**. For example, [!UICONTROL Landing Page Clicks (AJO)] metric has the context label [!UICONTROL :Landing page clicks (AJO)].
