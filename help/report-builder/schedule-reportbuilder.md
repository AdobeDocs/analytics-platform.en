...
1.  Click Schedule Workbook.
    ...
    ![alt description](./assets/schedule-workbook.png)
    ...
    ![alt description](./assets/schedule-pane.png)
...
1.  (Optional) Select **.zip compression** to compress the file and set up password protection on the file.
    ...
    ![alt description](./assets/zip-compression.png)
...
1.  Set up the scheduling options to set the date and time that you want the workbook emailed to your recipients.
    ...
    ![alt description](./assets/frequency.png)

1.  After you set the schedule, click **Send on schedule**.

    ![alt description](./assets/send-on-schedule.png)
    ...
    ![alt description](./assets/confirmation-toast.png)
...
![alt description](./assets/send-now.png)
...
1.  Select a workbook. Several tools are displayed that allow you to edit the workbook, change the schedule, pause and restart the schedule, or delete the schedule.
    ...
    ![alt description](./assets/edit-icons.png)
...
![alt description](./assets/history.png)
