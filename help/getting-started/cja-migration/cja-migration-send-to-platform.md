...
|---------|----------|
| New implementation of the Web SDK | Because this is a new implementation of the Web SDK, you must follow all steps described in [Ingest data via the Adobe Experience Platform Web SDK](/help/data-ingestion/aepwebsdk.md). | 
| Migrate your Adobe Analytics implementation to use the Web SDK | The steps for migrating to the Adobe Analytics Web SDK differ depending on whether your current implementation is the Analytics extension or AppMeasurement. <p>If you are using the Analytics tag extension: [Migrate from the Adobe Analytics tag extension to the Web SDK tag extension](https://experienceleague.adobe.com/en/docs/analytics/implementation/aep-edge/web-sdk/analytics-extension-to-web-sdk)</p><p>Or</p><p>If you are using AppMeasurement: [Migrate from AppMeasurement to the Web SDK](https://experienceleague.adobe.com/en/docs/analytics/implementation/aep-edge/web-sdk/appmeasurement-to-web-sdk) | 
| Configure your existing Adobe Analytics Web SDK implementation to send data to Customer Journey Analytics | Because your Adobe Analytics implementation is already using the Web SDK, you only need to [set up a datastream](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-data-ingestion/ingest-use-guides/edge-network/aepwebsdk#set-up-a-datastream). You can ignore the other section in [Ingest data via the Adobe Experience Platform Web SDK](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-data-ingestion/ingest-use-guides/edge-network/aepwebsdk).  | 
