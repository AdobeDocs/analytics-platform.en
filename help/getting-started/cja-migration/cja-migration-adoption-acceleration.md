---
title: Migrate to Customer Journey Analytics using the Adoption acceleration project
description: Plan your migration from Adobe Analytics to Customer Journey Analytics
role: Admin
solution: Customer Journey Analytics
feature: Basics
---
# Migration guide: Migrate to Customer Journey Analytics using the Adoption acceleration project

<--Russ' article will go here -->
