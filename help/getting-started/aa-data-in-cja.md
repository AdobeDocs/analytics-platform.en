...
1. **Enable Cross-Channel Analytics** as necessary. When utilizing multiple datasets in CJA, the identity stitching capabilities of Cross-Channel Analytics can resolve different ID namespaces into a single stitchedID. See [Cross-Channel Analytics overview](/help/connections/cca/overview.md) for more details.
