...
* You can also purchase Customer Analytics as a standalone product, without the need for Adobe Analytics.

## Access Control

Refer to the [Access Control](/help/getting-started/cja-access-control.md) topic.
