...
| Task | Details |
| --- | --- |
| **Step 1: If you are migrating from Adobe Analytics to CJA, read the admin guide.** | [Adobe Analytics to Customer Journey Analytics evolution](/help/getting-started/aa-to-cja.md) |
