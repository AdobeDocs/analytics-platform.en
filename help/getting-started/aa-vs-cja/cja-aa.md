...
| BI Extension | The BI Extension allows you to connect CJA directly to popular BI visuzliation tools such as PowerBI or Tableau allowing you to have your BI reports precisely match what you see in Analysis Workspace and other CJA reporting interfaces. This is a much easier way to get BI reporting for CJA without the need to recreate reports/metrics from raw data. |
