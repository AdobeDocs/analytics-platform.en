...
1. [Compare data in Adobe Analytics from your old implementation to data in Customer Journey Analytics from your new implementation](https://experienceleague.adobe.com/en/docs/experience-cloud-ai/experience-cloud-ai/coworker/data-validation-aa-cja) and make sure you understand any differences and why they exist. 
