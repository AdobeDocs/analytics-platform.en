...
1. [Compare data in Adobe Analytics from your old implementation to data in Customer Journey Analytics from your new implementation](https://experienceleague.adobe.com/en/docs/cx-enterprise-ai/experience-cloud-ai/coworker/chat/use-cases/data-insights/data-validation-aa-cja) and make sure you understand any differences and why they exist. 
...
1. Bring historical data from Adobe Analytics using the Analytics source connector: 
   ...
   1. [Create an XDM schema for the Analytics source connector](/help/getting-started/cja-upgrade/cja-upgrade-source-connector-schema.md){target="_blank"}.
