...
+ Use cases {#cja-usecases}
  ...
  + Data views {#data-views}
    ...
    + BI extension {#bi-extension}
      ...
      + [Hourly trend](/help/use-cases/data-views/bi-extension/hourly-trend)
      + [Monthly trend](/help/use-cases/data-views/bi-extension/monthly-trend)
      + [Single dimension ranked](/help/use-cases/data-views/bi-extension/single-dimension-ranked)
      + [Multiple dimension ranked](/help/use-cases/data-views/bi-extension/multiple-dimension-ranked)
      + [Count distinct dimension values](/help/use-cases/data-views/bi-extension/count-distinct-dimension-values)
      + [Use date range names to filter](/help/use-cases/data-views/bi-extension/use-date-range-names-to-filter)
      + [Use segment names to segment](/help/use-cases/data-views/bi-extension/use-segment-names-to-segment)
      + [Use dimension values to segment](/help/use-cases/data-views/bi-extension/use-dimension-values-to-segment)
      + [Sort](/help/use-cases/data-views/bi-extension/sort)
      + [Limits](/help/use-cases/data-views/bi-extension/limits)
      + [Transformations](/help/use-cases/data-views/bi-extension/transformations)
      + [Visualizations](/help/use-cases/data-views/bi-extension/visualizations)
      + [Caveats](/help/use-cases/data-views/bi-extension/caveats)
