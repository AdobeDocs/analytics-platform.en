...
+ Workspace projects {#cja-workspace}
  ...
  + Visualizations {#visualizations}
    ...
    + Fallout {#fallout}
      ...
      + [Configure a fallout](../analysis-workspace/visualizations/fallout/configuring-fallout.md)
    ...
    + Flow {#flow}
      ...
      + [Configure a flow](../analysis-workspace/visualizations/c-flow/create-flow.md)
      + [Inter-dimensional flows](../analysis-workspace/visualizations/c-flow/multi-dimensional-flow.md)
    + [Area](../analysis-workspace/visualizations/area.md#area)
    + [Area stacked](../analysis-workspace/visualizations/area.md#area-stacked)
    + [Bar](../analysis-workspace/visualizations/bar.md#bar)
    + [Bar stacked](../analysis-workspace/visualizations/bar.md#bar-stacked)
    ...
    + [Horizontal bar](../analysis-workspace/visualizations/horizontal-bar.md#horizontal-bar)
    + [Horizontal bar stacked](../analysis-workspace/visualizations/horizontal-bar.md#horizontal-bar-stacked)
    ...
    + [Summary change](../analysis-workspace/visualizations/summary-number-change.md#summary-change)
    + [Summary number](../analysis-workspace/visualizations/summary-number-change.md#summary-number)
