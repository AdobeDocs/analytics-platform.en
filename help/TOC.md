...
+ Components {#cja-components}
  ...
  + Calculated Metrics {#cja-calcmetrics}
    ...
    + Calculated Metrics workflow {#cm-workflow}
      ...
      + [Build Metrics](c-calcmetrics/cm-workflow/cm-build-metrics.md)
      + [Metric Type and Attribution](c-calcmetrics/cm-workflow/m-metric-type-alloc.md)
      + [Build a simple "Page Views per Visits" metric](c-calcmetrics/cm-workflow/cm-pvv.md)
      + [Segmented metrics](c-calcmetrics/cm-workflow/metrics-with-segments.md)
      + [Stack and replace segments](c-calcmetrics/cm-workflow/cm-stack-seg.md)
      + [Filtered and weighted metrics](c-calcmetrics/cm-workflow/cm-weighted-metric.md)
      + [Order Assists Metric](c-calcmetrics/cm-workflow/cm-orders-participation.md)
      + [Use functions](c-calcmetrics/cm-workflow/cm-using-functions.md)
      + [Participation Metric](c-calcmetrics/cm-workflow/participation-metric.md)
