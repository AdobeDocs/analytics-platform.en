...
+ Components {#cja-components}
  ...
  + Calculated Metrics {#cja-calcmetrics}
    ...
    + Calculated Metrics workflow {#cm-workflow}
      ...
      + [Build a simple "Page Views per Visits" metric](cja-calcmetrics/cm-workflow/cm-pvv.md)
      + [Filtered metrics](cja-calcmetrics/cm-workflow/metrics-with-segments.md)
      + [Stack and replace segments](cja-calcmetrics/cm-workflow/cm-stack-seg.md)
      + [Filtered and weighted metrics](cja-calcmetrics/cm-workflow/cm-weighted-metric.md)
      + [Order Assists Metric](cja-calcmetrics/cm-workflow/cm-orders-participation.md)
      + [Use functions](cja-calcmetrics/cm-workflow/cm-using-functions.md)
      + [Participation Metric](cja-calcmetrics/cm-workflow/participation-metric.md)
      + [Tag calculated metrics](cja-calcmetrics/cm-workflow/cm-tagging.md)
      + [Approve calculated metrics](cja-calcmetrics/cm-workflow/cm-approving.md)
      + [Share calculated metrics](cja-calcmetrics/cm-workflow/cm-sharing.md)
      + [Calculated Metric Manager](cja-calcmetrics/cm-workflow/cm-manager.md)
    + [Basic functions](components/cja-calcmetrics/cm-functions.md)
    + [Advanced functions](components/cja-calcmetrics/cm-adv-functions.md)
