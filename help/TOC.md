...
user-guide-description: This guide provides self-help assistance for Customer Journey Analytics, Adobe's next-generation, Adobe Experience Platform-based Analytics solution for cross-channel analytics.
