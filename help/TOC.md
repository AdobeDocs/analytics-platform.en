...
+ Components {#cja-components}
  ...
  + Calculated Metrics {#cja-calcmetrics}
    ...
    + Calculated Metrics workflow {#cm-workflow}
      + [Calculated metrics workflow](c-calcmetrics/cm-workflow/cm-workflow.md)
      + [Find metrics](c-calcmetrics/cm-workflow/cm-finding.md)
      + [Build Metrics](c-calcmetrics/cm-workflow/c-build-metrics/cm-build-metrics.md)
      + [Metric Type and Attribution](c-calcmetrics/cm-workflow/c-build-metrics/m-metric-type-alloc.md)
      + [Build a simple "Page Views per Visits" metric](c-calcmetrics/cm-workflow/c-build-metrics/cm-pvv.md)
      + [Segmented metrics](c-calcmetrics/cm-workflow/c-build-metrics/metrics-with-segments.md)
      + [Stack and replace segments](c-calcmetrics/cm-workflow/c-build-metrics/cm-stack-seg.md)
      + [Filtered and weighted metrics](c-calcmetrics/cm-workflow/c-build-metrics/cm-weighted-metric.md)
      + [Order Assists Metric](c-calcmetrics/cm-workflow/c-build-metrics/cm-orders-participation.md)
      + [Use functions](c-calcmetrics/cm-workflow/c-build-metrics/cm-using-functions.md)
      + [Participation Metric](c-calcmetrics/cm-workflow/c-build-metrics/participation-metric.md)
      + [Tag calculated metrics](c-calcmetrics/cm-workflow/cm-tagging.md)
      + [Approve calculated metrics](c-calcmetrics/cm-workflow/cm-approving.md)
      + [Share calculated metrics](c-calcmetrics/cm-workflow/cm-sharing.md)
      + [Calculated Metric Manager](c-calcmetrics/cm-workflow/cm-manager.md)
