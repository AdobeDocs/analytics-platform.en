...
>[!NOTE]
>
>You must have the **Select** package in order to use this functionality. Contact your administrator if you're unsure which Customer Journey Analytics package you have.
...
## Apply time comparison {#apply-time-comparison}
