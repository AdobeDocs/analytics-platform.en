...
| **[!UICONTROL Forecasting]** | Lets users view [forecasts](/help/analysis-workspace/c-forecast/forecasting.md) for time-series freeform tables and line visualizations. | 
