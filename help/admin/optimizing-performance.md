...
Various factors can influence overall CJA performance as well as the performance of a project within Analysis Workspace. In Workspace, you might get an error message that says "This report is too complex." [Is this the exact wording of the message?] This topic discusses which factors might lead to this error and how to simplify the report/project.

## Overall CJA performance 
