...
| **Data view size???** | The amount of data collected into your data view. |  | Consult with your implementation team or CJA expert to determine if there are implementation improvements that can be made to improve overall experience in CJA. |
| **Complexity of dimension settings** | Highly complex dimensions can have a significant impact on project performance. | Custom fields add complexity. | Reduce the number of custom fields or create separate dimensions. |
| **Dimensions with a lot of unique values** | Also known as high-cardinality dimensions, these dimensions may impact what can be reported on. | See [high-cardinality dimensions](/help/components/dimensions/high-cardinality.md) | See [high-cardinality dimensions](/help/components/dimensions/high-cardinality.md) |
