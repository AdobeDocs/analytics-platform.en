---
title: Content Analytics onboarding
description: How to onboardContent Analytics
...
>[!WARNING]
>
>This is an article part of the very preliminary, unofficial draft documentation for Content Analytics. All content is subject to change and no legal obligations whatsoever can be derived from this article.  
>
...
This section describes the onboarding flow.
...
>title="Details"
>abstract="Provide a name for the connection. In the **[!UICONTROL Data view]**, **[!UICONTROL Experience capture and definition]**, and **[!UICONTROL Data collection]** sections you provide more details to ensure Content Analytics can be configured correctly."
...
>title="Data view"
>abstract="For the configuration of Content Analytics you need to select an existing data view that you would like to merge your content analytics data with."
...
>abstract="Define which Tag property you want to use, or create a new one. And define the pages and assets your want to include or exclude, using regular expressions."
