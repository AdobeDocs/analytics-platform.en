...
| ![Curate](/help/assets/icons/Curate.svg) | **[!UICONTROL Components]** | Components in Analysis Workspace consist of the following:<ul><li>![Dimensions](/help/assets/icons/Dimensions.svg) [Dimensions](/help/components/dimensions/overview.md)</li><li>![Event](/help/assets/icons/Event.svg) [Metrics](/help/components/apply-create-metrics.md)</li><li>![Segmentation](/help/assets/icons/Segmentation.svg) [Filters](/help/components/filters/filters-overview.md)</li><li>![Calendar](/help/assets/icons/Calendar.svg) [Date ranges](/help/components/date-ranges/calendar.md)</li></ul>To learn more about each of these component types, see the [Components overview](/help/components/overview.md). |
