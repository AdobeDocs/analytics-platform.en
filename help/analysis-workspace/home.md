...
| ![Curate](/help/assets/icons/Curate.svg) | **[!UICONTROL Components]** | Components in Analysis Workspace consist of the following:<ul><li>![Dimensions](/help/assets/icons/Dimensions.svg) Dimensions</li><li>![Event](/help/assets/icons/Event.svg) Metrics</li><li>![Segmentation](/help/assets/icons/Segmentation.svg) Filters</li><li>![Calendar](/help/assets/icons/Calendar.svg) Date ranges</li></ul>To learn more about each of these component types, see the [Components overview](/help/components/overview.md). |
