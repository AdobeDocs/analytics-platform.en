...
| Template name | Why use this template <!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- |
| [!UICONTROL **Consent policy overview**] |View visitors based on consent policy membership data from Adobe Experience Platform.<p>**This can help you** as a starting point for reporting on visitor consent policy membership. When a data view is configured for consent reporting, Customer Journey Analytics automatically makes a consent policy analysis template available in Analysis Workspace. <br/>**Based on what you learn, you might** do any number of things, like exclude non-consenting visitors from analytics reporting.</p> |
