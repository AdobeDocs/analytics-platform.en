...
| | Allow forecasting to scale Y-axis | If you have forecast values that are outside of upper and lower bounds of the historical values, the y-axis does not automatically scale for these forecasted values. When turned on, this option does properly scale the y-axis for the the forecasted values. | 
