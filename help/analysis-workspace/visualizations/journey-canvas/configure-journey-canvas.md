...
1. Select one or more nodes where you want to create an audience, then right-click one of the selected nodes.
   ...
   >[!NOTE]
   >
   >Audiences cannot include calculated metrics. If you try to create an audience from any area of Journey canvas that contains a calculated metric, the calculated metric will not be included in the audience definition.
