...
1. Configure any of the following settings that are displayed across the top of the visualization:
   ...
   | [!UICONTROL **Percentage value**] | Choose from the following options: <ul><li>[!UICONTROL **Percent of start node**]: The percent of all people included in the data view within the panel's date range who also meet the criteria of a start node in the journey. <p>A _start node_ is a node that has no preceding nodes connected by an arrow. A journey can contain multiple start nodes. However, if the journey contains 2 or more start nodes that lead to a common node, then [!UICONTROL **Percent of total**] is used. If you want to use [!UICONTROL **Percent of start node**], update the journey so that each node can be traced back to a single start node.</p></li><li>[!UICONTROL **Percent of previous node**]: The percent of all people from the previous node included in the data view within the panel's date range.</li><li>[!UICONTROL **Percent of total**]: The percent of all people included in the data view within the panel's date range.</li></ul> | 
   | [!UICONTROL **Arrow settings**] | The arrows that appear between nodes in Journey canvas can be configured to show custom labels and values. Labels are custom names, which can be created in Journey canvas or in Journey Optimizer. Values show the fallthrough percentages<p>The following options are available, depending on your journey:</p><ul><li>[!UICONTROL **No labels**]: No labels are shown on arrows in the journey. </br> This option is available only if the journey has been modified in </li><li>[!UICONTROL **No labels and values**]: This option</li><li>[!UICONTROL **Labels only**]: This</li><li>[!UICONTROL **Values only**]: </li><li>[!UICONTROL **Labels and values**]: </li></ul><p>Choose from the following options to determine which are displayed:</p><ul><li>[!UICONTROL **None**]: No custom names, Journey Optimizer labels, or Journey Optimizer conditions are displayed on arrows in Journey canvas. </li><li>[!UICONTROL **Condition**]: Any condition labels that are configured in Journey Optimizer are shown on arrows in Journey canvas. Any custom names or other Journey Optimizer labels are not displayed.</li><li>[!UICONTROL **All labels**]: If an arrow contains a custom name, label, or condition, it is shown on the arrow in Journey canvas. Only one name, label, or condition is shown per arrow, in the following order of preference: <ol><li>A custom name added from Journey canvas (as described in [Rename a node or arrow](#rename-a-node-or-arrow))</li><li>A Journey Optimizer label</li><li>A Journey Optimizer condition</li></ol></li></ul><p>**Note**: This option displays only when Journey Optimizer data is detected in the same data view that is selected in the Analysis Workspace panel where you are adding the visualization. For information about changing the data view on a panel in Analysis Workspace, see [Analysis Workspace overview](/help/analysis-workspace/home.md).</p>  |
