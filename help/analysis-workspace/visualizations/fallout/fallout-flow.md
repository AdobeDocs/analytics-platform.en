...
See ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Create a fallout visualization report](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/analysis-workspace/analyzing-customer-journeys/fallout-visualization){target="_blank"} for a demo video.
