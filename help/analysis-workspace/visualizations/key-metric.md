...
*This article documents the Key metric summary visualization in **Customer Journey Analytics**. See [Key metric summary](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/key-metric) for the **Adobe Analytics** version of this article.*
