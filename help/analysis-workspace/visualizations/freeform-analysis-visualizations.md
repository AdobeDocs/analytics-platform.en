...
| [Key metric summary](/help/analysis-workspace/visualizations/key-metric.md)<p>![KeyMetrics](/help/assets/icons/KeyMetrics.svg) | A Key metrics summary visualization combines the line, summary change, and summary number visualizations. |
