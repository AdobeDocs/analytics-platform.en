...
*This article documents the Freeform table visualization in **Customer Journey Analytics**. See [Freeform table](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/freeform-table/freeform-table) for the **Adobe Analytics** version of this article.*
