...
When you sort data for multiple columns, data is sorted according to the priority you assign to each column. Priority numbering is displayed next to the sort icon ![SortOrderDown](/help/assets/icons/SortOrderDown.svg)<sup>➊</sup>.
