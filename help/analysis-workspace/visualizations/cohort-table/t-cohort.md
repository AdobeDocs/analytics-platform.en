...
1. In the [Filter builder](/help/components/filters/filter-builder.md), further edit the segment, then click **[!UICONTROL Save]**.

   The saved segment is available for use in the [!UICONTROL Filter] panel in [!UICONTROL Analysis Workspace].
