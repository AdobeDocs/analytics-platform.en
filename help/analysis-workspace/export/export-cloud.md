...
* Calculated metrics that use unsupported functions in the metric definition (see [Unsupported calculated metric functions](#calculated-metric-functions-support) for more information)
