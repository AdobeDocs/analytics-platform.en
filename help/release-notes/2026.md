...
| Feature and description | [Rollout starts](releases.md) | [General Availability](releases.md) |
| -----------|-----------|-----------|
| **Brand Visibility integration**<br>The [Brand Visibility inbound integration](/help/integrations/bv.md#inbound-integration) enables you to ingest Brand Visibility data into Customer Journey Analytics for further analysis. | | July 28, 2026 |
