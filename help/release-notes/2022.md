...
| **Return Session Reporting** | Discover if a particular session was a user's return session. [Learn more](/help/data-views/data-views-usecases.md)  | September 15, 2022 |
