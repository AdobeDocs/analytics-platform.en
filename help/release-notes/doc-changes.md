...
|---|---|
| **March 2026** | |
| Technote on Bad IDs (BAVIDs) | New technote on Bad IDs. The technote  explains the definition of a Bad ID, where in the Customer Journey Analytics interface Bad IDs are used, and how to investigate data in your connection for Bad IDs. |
