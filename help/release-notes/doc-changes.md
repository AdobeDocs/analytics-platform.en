...
| Derived fields | Documentation on [derived fields](../data-views/derived-fields/derived-fields.md) functionality. |
| **April 2023** |  |
...
| October 2022 | New topic on [CJA Audit Log](/help/privacy/audit-log.md). |
...
| May 2022 | New article on [ingesting Adobe Experience Platform audiences into CJA](/help/use-cases/data-ingestion/ingest-aep-segments.md). |
| **April 2022** | |
