...
| --- | --- |
| February 2022 | [Prepare to migrate from Adobe Analytics to Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/aa-to-cja.html?lang=en) |
...
| October 2021 | Documented [Visualizations for Analytics dashboards](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dashboards/create-scorecard.html?lang=en#apply-visualizations) |
| October 2021 | Doc for rolling window for [!UICONTROL Connection] [data retention](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=en#set-rolling-window-for-connection-data-retention).<p>**Note: Please contact Customer Care or your Adobe account manager to have this setting implemented. It is not yet available via the CJA UI.** |
| September 2021 | [Metric deduplication](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/metric-deduplication.html?lang=en) doc |
| September 2021 | [Daylight Savings Time support in reporting](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/create-dataview.html?lang=en#calendar) |
| September 2021 | [Customer calendars](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/create-dataview.html?lang=en#calendar) documentation |
| September 2021 |  [Boolean fields](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/behavior.html?lang=en) documentation |
...
| September 2021 | New section on the [implications of merging report suites](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html?lang=en#6.-considerations-when-merging-report-suites-in-cja) in CJA. |
...
| September 2, 2020 | Updated section on [user permissions](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-overview.html?lang=en). |
| August 7, 2020| New topic on [B2B use case - lookup dataset](/help/use-cases/b2b.md) added. |
| July 2020| Added information on [Identity Map option for Person ID](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/create-connection.html?lang=en). |
