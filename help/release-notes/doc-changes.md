...
| --- | --- |
| **January 2024** | |
| Forecasting | Added documentation on [forecasting](../analysis-workspace/c-forecast/forecasting.md), the new Analysis Workspace feature to forecast a standard or calculated metric with any supported time granularity (hourly, daily, weekly, monthly and yearly) for freeform tables and lince charts. |
