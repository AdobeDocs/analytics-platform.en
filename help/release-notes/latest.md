...
| **Experience Edge geo lookups** | [Adobe Experience Edge](https://experienceleague.adobe.com/docs/experience-platform/edge/datastreams/configure.html?lang=en) is adding a geo lookup service that provides unified geographic data to all Experience Edge users (Adobe Analytics, Customer Journey Analytics, Adobe Target, Adobe Media Analytics, Adobe Experience Platform, etc.). | N/A | July 26, 2023 |
