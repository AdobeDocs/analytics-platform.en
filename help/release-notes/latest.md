...
| **Edge Network bot detection** | [Bot detection](https://experienceleague.adobe.com/docs/experience-platform/datastreams/bot-detection.html) allows you to identify events generated by the Web SDK, Mobile SDK and Server API as being generated by known spiders and bots. | | April 29, 2024 |
...
| **Adobe Product Analytics: Share with Anyone** | Lets you share a read-only link to Adobe Product Analytics projects with people who don't have access to Product Analytics. |  | End of March, 2024 |
