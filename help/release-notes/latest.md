...
| **Real-time reporting** | Real-time reporting in Customer Journey Analytics displays and updates data and visualizations within one or more panels in Analysis Workspace in real time.<br/><br/>(Documentation link to folow.) | | September 18,  2025 (Originally planned to release on August 15, 2025)|
| **Support for data mirror**  | With support for ad-hoc and model-based schemas, and the Change Data Capture functionality for specific source connectors in Experience Platform, Customer Journey Analytics will be able to support data mirror functionality of Data Warehouse Native (DWN) solutions like Snowflake, Databricks and Google BigQuery. <p>Contact your Adobe Account Team to access the beta.</p>  | Beta release starting September 24 | TBD |
