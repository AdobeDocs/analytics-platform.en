...
| **Administrators can manage all locations in their organization** | A new option on the [Locations](https://experienceleague.adobe.com/docs/analytics/components/locations/locations-manager.html) page allows Administrators to view and manage all locations in the organization. Previously, administrators could view and manage only the locations they created. | | April 2024 |
