...
| **Lookup keys limit increased to 1 billion** | The maximum number of unique keys for a lookup dataset is now 1 billion. <p>Previously, the maximum number was 10 million.<p>For more information, see [Guardrails](/help/technotes/guardrails.md).</p> | | September 18, 2025 |
