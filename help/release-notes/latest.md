...
| **Attribution model API reporting guide - Move to AA only** <br/>A new Adobe Analytics 2.0 API Attribution Model Report Guide is available. The guide covers how to include attribution model object data in Dimension API reports.<p>(Documentation link to follow.)</p> | | May 2026 |
| **Use Customer Journey Analytics data in LLM Optimizer** <br/> | Connect LLM Optimizer with your organization's Customer Journey Analytics data so you can measure how AI-driven discovery translates into real website engagement and business outcomes.<p>(Documentation link to follow.)</p> | End of May 2026 |
| **Data Insights Agent on Agent Orchestrator** <br/> | | End of May 2026 |
