...
| **Additional skills in CX Enterprise Coworker**<br>New skills are coming to Coworker, including:<ul><li>**Implementation guides skills**: Generate a tailored list of implementation steps and recommendations. That output can then be transformed into a CW Project using a predefined playbook.</li><li>**Intelligent implementation checklist skills**: Use the CW Project to manage and track implementation progress, maintain project state, collaborate across teams, assign tasks, and introduce approval gates where needed. In addition, we are progressively adding automation to implementation steps whenever supporting tools, APIs, or MCP capabilities are available.</li><li>**Data validation skills**: Verify that their implementations are configured correctly and aligned with best practices.</li></ul><p>(Documentation links to follow.)</p> | | September 30, 2026 |
