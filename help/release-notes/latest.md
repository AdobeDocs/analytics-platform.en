...
| **Intelligent Captions v2** | Intelligent captions are now supported for the following visualizations: Multi-line, Bar, Horizontal bar, Donut, Area, Flow, and Fallout. You can select to show all intelligent captions at once in an expanded view, or you can show individual intelligent captions in a one-by-one view. (Documentation link to follow)|  | January 22, 2025 |
| **Add guided analyses to projects from within Guided Analysis**  | Lets you add guided analyses to Workspace projects from within Guided Analysis. You can also add guided analyses directly in Analysis Workspace. (Documentation link to follow) |  | January 22, 2025 |
