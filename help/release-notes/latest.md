...
| ----------- | ---------- | ----- |
| **Combo Charts visualization in Workspace** |  Combo charts let you compare metrics more easily and intuitively within Workspace. Learn more  | September 14, 2022 |
