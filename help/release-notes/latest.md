...
| **API Search and Sort - Move to AA only** <br/>New search and sort capabilities are available for the Adobe Analytics 2.0 API. <p>For more information, see the Search and Sort guide. (Documentation link to follow.)</p> | | TBD |
