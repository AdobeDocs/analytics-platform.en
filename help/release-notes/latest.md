...
---
# Current Customer Journey Analytics release notes (September 2025)
...
| **Real-time reporting** | Real-time reporting in Customer Journey Analytics displays and updates data and visualizations within one or more panels in Analysis Workspace in real time.<br/><br/>(Documentation link to follow.) | September 18,  2025 (Originally planned to release on August 15, 2025) | October 8, 2025 |
