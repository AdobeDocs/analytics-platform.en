...
| **Adobe Product Analytics: Show/Hide Series** |  Click on the chart legend or table rows to control the visibility of series in your visualizations.  Learn more (coming soon) | N/A | October 4, 2023 |
| **Annotations in Adobe Product Analytics** | Guided analysis projects now support the ability to view annotations. Refer to each view type in [Guided analysis](/help/guided-analysis/overview.md) for details around how it interacts with annotations. Learn more (coming soon)| N/A | October 4, 2023 |
