...
| ----------- | ---------- | ----- | --- |
| **Update to CJA Audiences** | After you have created an audience, [Adobe creates an Experience Platform streaming segment for each new CJA Audience](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html#after-audience-created). An AEP streaming segment will only be created if your organization is set up for streaming segmentation. | N/A | February 3, 2023 |
