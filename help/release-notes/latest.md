...
| **Data storytelling: Generate slide presentations from Workspace reports** | You can now automatically generate a slide presentation (in .pptx format) that is based on an Analysis Workspace report. Workspace detects key insights in your report and converts them into stakeholder-ready slides.<p>This feature reduces the time and effort required to surface findings, build executive narratives, and communicate business impact.</p><p>(Documentation link to follow.)</p> | October 22, 2025 | January 2026 |
