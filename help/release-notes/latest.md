...
| **Table of contents for Workspace projects** | A new table of contents is now available for projects. The table of contents provides links that enable users to quickly move between panels and visualizations within the project. <p>The table of contents is available in the left rail in all projects.</p><p>For more information, see [Project table of contents](/help/analysis-workspace/build-workspace-project/project-table-of-contents.md). |  | June 19, 2024 |
