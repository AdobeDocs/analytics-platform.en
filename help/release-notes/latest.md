...
| ----------- | ---------- | ------- | ---- |
| **New capabilities in Adobe Product Analytics** |<ul><li>**Trend lines**: The [Usage view](/help/guided-analysis/types/usage.md) now supports trend lines. Click [!UICONTROL Overlays] to enable them.</li><li>**Query breakdowns**: The [Usage view](/help/guided-analysis/types/usage.md) now supports query breakdowns. They are available as an option in the query rail.</li><li>**Retention analysis**: The [Retention rates](/help/guided-analysis/types/retention-rates.md) view type shows the percentage of users that return after their initial engagement.</li></ul> | N/A | October 25, 2023 |
