...
| **Use your Customer Journey Analytics data view with Adobe Journey Optimizer** | A new configuration option in Customer Journey Analytics allows you to designate a Customer Journey Analytics data view to use with Adobe Journey Optimizer, without the need for manual configuration. <!-- add this in: <p>For information about how to enable this configuration option, see the [Compatibility](/help/data-views/create-dataview.md#compatibility) section in [Create or edit a data view](/help/data-views/create-dataview.md).</p> --><p>Previously, you had to manually configure a connection and data views when viewing Adobe Journey Optimizer data in Customer Journey Analytics.</p><p>(Documentation link to follow)</p> |  | June 19, 2024 |
