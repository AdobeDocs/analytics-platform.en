...
| **Return Session Reporting** | Discover if a particular session was a user's return session. [Learn more](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html?lang=en#new-repeat) | September 13, 2022 |
