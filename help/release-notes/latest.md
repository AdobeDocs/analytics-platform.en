...
| **Annotations in Adobe Product Analytics** | Guided analysis projects now support the ability to view annotations. Refer to each view type in [Guided analysis](/help/guided-analysis/overview.md) for details around how it interacts with annotations. | N/A | October 4, 2023 |
