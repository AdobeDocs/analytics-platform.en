...
| **Share accounts and locations that are used for export and import** | Users can now make the accounts and locations they create available to all users in their organization. Only account and location owners and system administrators can edit and delete accounts and locations. Previously, accounts and locations could be used only by the user who created them. These settings are available when users [configure cloud export accounts](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-components/exports/cloud-export-accounts) and [configure cloud export locations](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-components/exports/cloud-export-locations).| June 12, 2024 | June 18, 2024 |
| **Select multiple filters when they are available in the drop-down menu in a freeform table** |When multiple filters have been added to a freeform table as a drop-down menu, users of the freeform table can now select more than one filter at a time. The freeform table is filtered to include any of the selected filters. <p>Previously, users could select only one filter at a time in a filter drop-down menu.</p><p>(Documentation link to follow.)<!--For more information, see "Add filters to a project" in "Use components in Analysis Workspace."--> |  | June 19, 2024 |
| **Table of contents for Workspace projects** | A new table of contents is now available for projects. The table of contents provides links that enable users to quickly jump to panels and visualizations within the project. <p>The table of contents can be enabled for individual projects or for all projects for a given user.</p><p>(Documentation link to follow.)<!--For more information, see "Display the project table of contents" in "Create projects".--> |  | June 19, 2024 |
