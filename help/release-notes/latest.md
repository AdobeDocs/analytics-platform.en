...
| **Content Analytics: Scatter visualization thumbnails and previews** <p>Added support for Content Analytics thumbnails and previews for assets and experiences in scatter visualizations.</p><p>(Documentation link to follow.)</p> |  February 17, 2026| March 2, 2026 |
| **Content Analytics: Bar visualization thumbnails and previews** <p>Added support for Content Analytics thumbnails and previews for assets and experiences in horizontal bar visualizations.</p><p>(Documentation link to follow.)</p>| February 23, 2026 | March 9, 2026 |
