...
| Transform data | Shows the transformation status of applicable B2B lookup datasets. See [Transform datasets for B2B lookups](transform-datasets-b2b-lookups.md) for more information.<p><span style="color:green">●</span>&nbsp;&nbsp;&nbsp;**[!UICONTROL _x_ On]** for datasets enabled for transformation, <p><span style="color:gray">●</span>&nbsp;&nbsp;&nbsp;**[!UICONTROL _x Off_]** for datasets not enabled for transformation, and<p>**[!UICONTROL N/A]** for all other datasets not applicable for transformation.| 
