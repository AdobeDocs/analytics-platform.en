...
| **[!UICONTROL Dataset type]** | The [dataset type](create-connection.md#dataset-types). Type can be [!UICONTROL Event], [!UICONTROL Profile], [!UICONTROL Lookup], [!UICONTROL Summary], or [!UICONTROL Adhoc]. |
