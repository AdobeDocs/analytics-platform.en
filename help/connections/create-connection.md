...
1. Configure the connection settings.
    ...
    | [!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"}<br/>**[!UICONTROL Primary ID]** | Select the proper primary ID for your connection: <ul><li>![User](/help/assets/icons/User.svg) **[!UICONTROL Person]** for a B2C scenario</li><li> ![Building](/help/assets/icons/Building.svg) **[!UICONTROL Account]** for a B2B scenario.</li></ul> |
    | [!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"}<br/>**[!UICONTROL Optional containers]** | Select additional containers.<ul><li>**[!UICONTROL Global account]**: enables configuration of global accounts in a connection.</li><li>**[!UICONTROL Opportunity]**: enables configuration of opportunities in a connection.</li><li>**[!UICONTROL Buying group]**: enables configuration of buying groups in a connection.</li><ul> |
    ...
    | [!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"}<br/>**[!UICONTROL Account ID]** | The Account ID that is used to support account-based reporting for the dataset. |
    | [!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"}<br/>**[!UICONTROL Global Account ID]** | The global account ID that is used to lookup global account data. |
    | [!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"}<br/>**[!UICONTROL Buying Group ID]** | The Buying Group ID that is used to lookup buying group data. |
    | [!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"}<br/>**[!UICONTROL Opportunity ID]** | The Opportunity ID that is used to lookup opportunity data. | 
...
1. Select one or more datasets and select **[!UICONTROL Next]**. You will [configure](#configure-datasets) each of the datasets. At least one event dataset must be part of the connection.


## Configure datasets 

You configure each of the selected datasets, one by one, in the ➋ **[!UICONTROL Datasets settings]** step of the **[!UICONTROL Add datsets]** dialog.
...
![Add dataset B2B](assets/add-dataset-b2b.png)

>[!ENDTABS]

| Setting | Description |
| --- | --- |
| [!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"}<br/>**[!UICONTROL Account ID]** | Only available for event datasets and for lookup datasets that are [matched by container](/help/getting-started/cja-b2b-concepts-features.md#match-by-container-or-field). Select an account ID (the unique identifier for an account) from the available identities defined in the dataset schema in the Experience Platform. |
| [!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"}<br/>**[!UICONTROL Opportunity ID]** | Only available for event datasets. Select an opportunity ID (the unique identifier for an opportunity) from the available identities defined in the dataset schema in the Experience Platform. |
| [!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"}<br/>**[!UICONTROL Buying Group ID]** | Only available for event datasets. Select a buying group ID (the unique identifier for a buying group) from the available identities defined in the dataset schema in the Experience Platform. |
...
| [!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"} **[!UICONTROL Matching key type]** | Select how to join the datasets: based on a **[!UICONTROL Match by field]** or **[!UICONTROL Match by container]**. See [Match by container of field](/help/getting-started/cja-b2b-concepts-features.md#match-by-container-or-field) for more information.|
| **[!UICONTROL Matching key]** | Only available for lookup or profile datasets. The matching key to join on in one of the event datasets. If this list is empty, you probably haven't added or configured an event dataset. <br/><br/>[!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"}<br/>Based on your selected **[!UICONTROL Matching key type]**, select the appropriate value:<ul><li>**[!UICONTROL Match by field]**: Select a field to join on with one of the event datasets. If this list is empty you probably haven't added or configured an event dataset.</li><li>**[!UICONTROL Match by container]**: Select a container to use to join with one of the event datasets. The containers available to select are determined by the containers you included as part of setting up the connection. If this list is empty you probably haven't configured one or more containers.</li></ul>  |
| [!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"}<br/>**[!UICONTROL Account field]** | The account id to use for account-based reporting. | 
...
| **[!UICONTROL Remove]** | You can delete or remove the dataset and change the [!UICONTROL Person ID] or [!UICONTROL Account ID] [!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"} without deleting the whole connection. Deleting or removing reduces the costs involved in data ingestion and the cumbersome process of recreating the whole connection and associated data views. |
...
[!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"} 
...
This map helps you to get a better understanding of how you have defined your connection and set up the relationship between your event, profile and lookup datasets using identifiers.
...
|Dataset Type|Description|Timestamp|Schema|Person ID <br/> Account ID [!BADGE B2B Edition]{type=Informative url=“<https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b-edition> newtab=true tooltip="Customer Journey Analytics B2B Edition"}  |
|---|---|---|---|---|
