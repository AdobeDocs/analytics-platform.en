...
||No IDs are present in Identity Map|No IDs are marked as primary|Multiple IDs are marked as primary|Single ID is marked as primary	|Invalid Namespace with an ID marked as primary|
|---|---|---|---|---|---|
