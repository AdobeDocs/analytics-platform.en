...
1. Configure the connection settings.
    ...
    | [!BADGE B2B Edition]{type=Informative} **[!UICONTROL Account ID]** | The Account ID that is used to support account-based reporting for the dataset. |
    | [!BADGE B2B Edition]{type=Informative} **[!UICONTROL Global Account ID]** | The global account ID that is used to lookup global account data. |
    | [!BADGE B2B Edition]{type=Informative} **[!UICONTROL Buying Group ID]** | The Buying Group ID that is used to lookup buying group data. |
    | [!BADGE B2B Edition]{type=Informative} **[!UICONTROL Opportunity ID]** | The Opportunity ID that is used to lookup opportunity data. | 
