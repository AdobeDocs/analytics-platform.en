...
1. Now configure the datasets one by one.
    ...
    | **[!UICONTROL Data source type]** | Types of data sources include: Web data, Mobile App data, POS data, CRM data, Survey data, Call Center data, Product data, Accounts data, Transaction data, Customer Feedback data, and Other. |
