...
3. Now, configure the datasets one by one.
    ...
    | **[!UICONTROL Import new data]** | Turn this option [!UICONTROL On] if you want to establish an ongoing connection. When selected any new data batches that get added to the datasets in this connection automatically flow into Workspace. |
