...
>
>Also if you remove the source dataset, the stitched dataset will stop processing and will get removed by the system.
...
* If a device is shared by multiple people and the total number of transitions between users exceeds 50.000, CCA will stop stitching hits for that device.
