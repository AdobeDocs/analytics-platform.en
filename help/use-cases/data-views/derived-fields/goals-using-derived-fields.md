...
If you are not familiar with derived fields, refer to the [tutorial](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/data-views/derived-fields-in-cja.html) and [documentation](/help/data-views/derived-fields/derived-fields.md) for an introduction.
