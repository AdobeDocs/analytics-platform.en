...
1. Select **[!UICONTROL Connections]** (from **[!UICONTROL Data Management]**) in the top menu.
...
1. Select **[!UICONTROL Customer Journey Analytics]** from the &nbsp; ![App](/help/assets/icons/Apps.svg) &nbsp; app switcher.
1. Select **[!UICONTROL Data views]** (from **[!UICONTROL Data Management]**) in the top menu.
