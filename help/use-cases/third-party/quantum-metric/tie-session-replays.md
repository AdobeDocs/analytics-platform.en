...
These steps require that you use tags in Adobe Experience Platform Data Collection.

## Step 1: Capture the Quantum Metric session ID using the Quantum Metric tags extension

Following these steps append the Quantum Metric session ID to the data that you send to Adobe Experience Platform.
...
Each session ID is now a clickable link. These links take you to Quantum Metric in a new tab, allowing you to analyze that particular session in more detail. From here, you an apply an interesting segment to your Workspace project and explore those sessions further in Quantum Metric.

See [Create hyperlinks in a freeform table](/help/analysis-workspace/visualizations/freeform-table/freeform-table-hyperlinks.md) for more information on adding hyperlinks to Analysis Workspace dimension items.
