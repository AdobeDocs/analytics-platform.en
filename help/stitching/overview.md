...
>[!NOTE]
>
>You do **not** require a Real-time Customer Data Platform license for graph-based stitching. The **Select** or higher package of Customer Journey Analytics include the required User Identity Service entitlements.
