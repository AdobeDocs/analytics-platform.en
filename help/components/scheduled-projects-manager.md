...
To edit a scheduled project, select the title of the scheduled project. Use the **[!UICONTROL Edit scheduled project]** dialog to update the schedule details. See [Send files to other](../analysis-workspace/curate-share/t-schedule-report.md) for more details.
