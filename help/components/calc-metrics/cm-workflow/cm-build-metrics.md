...
1. Access the calculated metric builder in any of the follows ways:
   ...
   * In Analysis Workspace, open a project, then select the **Plus** icon next to the [!UICONTROL **Metrics**] section in the left panel.
