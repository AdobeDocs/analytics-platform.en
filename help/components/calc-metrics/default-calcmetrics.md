...
| Time Spent/User (State) | The length of time that the average visitor spends in a particular State while on the site | `[Mobile App Users] (filter)`<br>`[Time Spent per Visitor (Seconds)] (metric)` |
...
| Unique Visitors / Unique Visitors returning after 7 days  | The percentage of unique visitors who are returning after a period of 7 or more days. | `[Unique Visitors metric with Users returning after 7 days filter] / [Unique Visitors]` |
