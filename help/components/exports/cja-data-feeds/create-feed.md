...
1. Select [!UICONTROL **Create data feed**]. 
   ...
   A page displays with the following categories: [!UICONTROL **Details**], [!UICONTROL **Data structure**], and [!UICONTROL **Delivery**].
...
1. In the [!UICONTROL **Delivery**] section, specify the following information:
   ...
   | Field | Function |
   |---------|----------|
   | Feed type | Select from the following options:<ul><li>Live feed</li><li>Backfill feed</li></ul>
