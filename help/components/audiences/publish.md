...
>abstract="The frequency at which an audience's membership is reevaluated.<br/>One time audiences are evaluated only once, and do not count toward your refresh limit."
...
>abstract="The number of audiences in your environment that are configured to automatically refresh at a scheduled frequency. Limits are between 75 and 150, depending on your Customer Journey Analytics entitlement. One time refreshes do not count toward this limit."
...
1. To create and publish an audience, do one of the following:
   ...
   | --- | --- |
   | From within the **[!UICONTROL Published audiences]** interface | Select **[!UICONTROL Components]** > **[!UICONTROL Published audiences]** from the main Customer Journey Analytics menu. The Audiences interface displays. Select **[!UICONTROL Create audience]** and the [!UICONTROL Audience builder] opens. |
