...
1. Interpret the data using the [Date preview](#data-preview).
...
| **[!UICONTROL Date preview]** | Select ![Info](/help/assets/icons/Info.svg) to show or hide the [Date preview](#date-preview) for the selected date range and refresh frequency. |

## Data preview

The Date preview provides the following information.
...
| **[!UICONTROL Preview metrics]** | You can select a specific metric to see how data for that metric is based on the audience you define.  These panels display a total for the metric and a percentage from the total of the metric, as defined by the data view. For example, 381 people are the result of your audience definition, which is 5% of the total people available in the data view you have selected for the audience. You can select any metric that is available in your data view.  |
