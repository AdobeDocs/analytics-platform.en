...
| **[!UICONTROL Time granularity]** | Select how often you want the metric to be checked: Daily, Weekly, or Monthly.<p><b>Note</b>: For data views with a custom calendar, monthly granularity is not supported in the Alert Builder.<!--true?--></p> | 
