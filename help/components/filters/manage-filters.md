...
You can [share](segments-share.md), [segment](segments-segment.md), [tag](segments-tag.md), [approve](segments-approve.md), rename, [copy](segments-copy.md), delete, export segments and mark segments as [favorite](segments-favorite.md) from a central [!UICONTROL Filters] management interface. To manage segments:
...
![Filters interface](assets/segments-manager.png)
...
| Column | Description |
| --- | --- | 
| ![StarOutline](/help/assets/icons/StarOutline.svg)  | Select to favor ![Star](/help/assets/icons/Star.svg) or un-favor ![StarOutline](/help/assets/icons/StarOutline.svg) a segment. See [Mark segment as favorite](/help/components/segments/segments-favorite.md) |
| **[!UICONTROL Title and description]** | To edit the segment, select the title link, which opens the [Filters builder](segment-builder.md). A shared segment is indicated with ![Share](/help/assets/icons/ShareAlt.svg). |
...
| Action | Description |
|---|---|
| ![AddCircle](/help/assets/icons/AddCircle.svg) **[!UICONTROL Add]** | Add another segment, using the [Filter builder](segment-builder.md). |
...
| ![Label](/help/assets/icons/Label.svg) **[!UICONTROL Tag]** | Tag the selected segments. In the **[!UICONTROL Tag Filter]** dialog, select or de-select the tags for the selected segments. Select **[!UICONTROL Save]** to save the tags for the selected segments. See [Tag segments](/help/components/segments/segments-tag.md) for more information.|
| ![Share](/help/assets/icons/ShareAlt.svg) **[!UICONTROL Share]** | Share the selected segments. In the **[!UICONTROL Share Filter]** dialog, you can ![Search](/help/assets/icons/Search.svg) *Search individuals or groups* or you can select **[!UICONTROL Organization]** or **[!UICONTROL Groups]**. Select **[!UICONTROL Save]** to save share details for the selected segments. See [Share segments](segments-share.md) for more information. |
...
| ![CheckmarkCircle](/help/assets/icons/CheckmarkCircle.svg) **[!UICONTROL Approve]** | Approve the selected segments. See [Approve segments](segments-approve.md) for more information. | 
...
You can segment the list of segments using the ![Filter](/help/assets/icons/Filter.svg) **[!UICONTROL Filter]** left panel ➍. The segment panel displays the type of segment and the number of segments that honor the specific segment. Select ![Filter](/help/assets/icons/Filter.svg) to toggle the display of the segment panel. 

See [Filter the list of segments](segments-segment.md) for more information.
