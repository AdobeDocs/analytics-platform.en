...
| **[!UICONTROL Event]**<br/>**[!UICONTROL Session]**<br/>**[!UICONTROL Person]** | Select from the dropdown ![ChevronDown](/help/assets/icons/ChevronDown.svg) the scope of the quick segment. |
