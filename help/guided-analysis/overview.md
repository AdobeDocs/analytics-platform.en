...
1. Drag any view type onto the Workspace canvas, then select **[!UICONTROL Create *guided analysis*]**  to generate the desired analysis (for example: **[!UICONTROL Create Trends]**). You can also drag an existing analysis onto the Workspace canvas from under the **[!UICONTROL Saved]** section.
