...
The ![NetGrowth](/help/assets/icons/NetGrowth.svg) **[!UICONTROL Net growth]** analysis type provides insights around the rate at which you gain or lose users over a specific period. The horizontal axis is a time interval, while the vertical axis is the measurement of growth.
...
Similar to the [Active](active-growth.md) analysis type, users are defined as the following:
...
* **[!UICONTROL View]**: Switch between this analysis type and [Active growth](active-growth.md).
