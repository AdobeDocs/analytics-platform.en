...
>title="Include exclude values"
>abstract="Narrow a dimension to only include values matching specific criteria. Inclusions and exclusions happen before allocation and segmentation in reports. Determine if the specified segment logic is case-sensitive."
