...
| Profile-based | The scope of the metric component is profile based. When the component is used in reporting, date ranges, the metric returns the population from your profile data, regardless of the date range applied to the panel. Date filters and date-range comparisons do not affect the reporting of this metric. |
