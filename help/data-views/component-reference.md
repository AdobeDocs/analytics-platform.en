...
| [!UICONTROL Session Starts] | Metric | The number of events that were the first event of a session. When used in a filter definition (e.g. '[!UICONTROL Session Starts] exists'), it filters down to just the first event of every session.<p>This component is required in your data view in order for the following calculated metric to be available in Analysis Workspace: <ul><li>Session Start Rate</li></p> |
| [!UICONTROL Session Ends] | Metric | The number of events that were the last event of a session. Similar to [!UICONTROL Session Starts], it can also be used in a filter definition to filter things down to the last event of every session.<p>This component is required in your data view in order for the following calculated metric to be available in Analysis Workspace: <ul><li>Session End Rate</li></p> |
...
| [!UICONTROL Time Spent (seconds)] | Metric | Sums the time between two different values for a dimension.<p>This component is required in your data view in order for the following calculated metrics to be available in Analysis Workspace: <ul><li>Time Spent Per Person</li><li>Time Spent Per Session</li></p> |
