...
| [!UICONTROL Lower case] | *New* - For "string" type dimensions. This setting lets you control whether Customer Journey Analytics treats dimension values as case sensitive. It allows for de-duplication of rows that have the same value, but a different case. This screenshot shows an example of a case-sensitive dimension in Workspace:<br>![case-sensitive dimension](assets/case-sens-workspace.png) |
