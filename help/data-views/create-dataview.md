...
| Setting | Description |
| --- | --- |
| [!UICONTROL **Set as default data view in Adobe Journey Optimizer**] | This configuration option allows you to perform advanced analysis of your Adobe Journey Optimizer data in Customer Journey Analytics. To perform this type of analysis, Adobe Journey Optimizer needs access to a Customer Journey Analytics data view.<p>Enable this option to make this the default data view that is used in Adobe Journey Optimizer reporting. <p>This configuration option automatically:</p><ul><li>Configures all the required Adobe Journey Optimizer datasets in the associated connection in Customer Journey Analytics for use with Adobe Journey Optimizer.</li><li>Creates a set of Adobe Journey Optimizer metrics and dimension in the data view (including derived fields and calculated metrics). Context labels are automatically set on all of these metrics and dimensions.<!--do we need to provide a list somewhere? See https://wiki.corp.adobe.com/display/CJM/Required+Metrics+and+Dimensions--></li><p>**Note:** If needed, you can make additional, manual customizations to the datasets, dimensions, or metrics that are available in your data views that you use for both Adobe Journey Optimizer and Customer Journey Analytics, as described in [Integrate Adobe Journey Optimizer with Adobe Customer Journey Analytics](/help/integrations/ajo.md). </p></ul><p>You can change the default data view at a later time, but doing so could alter your Adobe Journey Optimizer reporting data. If you choose to disable it after it is enabled, you will be prompted to select a new default data view.</p><!-- add this in when the Open in CJA button is introduced: "Enabling this configuration option on a data view allows you to perform advanced analysis of your Adobe Journey Optimizer data in Customer Journey Analytics (by selecting the [!UICONTROL **Open in CJA**] button while in Adobe Journey Optimizer)." --></p> |
