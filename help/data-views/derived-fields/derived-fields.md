...
1. A green checkmark <span style="color:green">![Checkmark](https://spectrum.adobe.com/static/icons/ui_18/CheckmarkSize50.svg)</span> indicates whether your math formula is valid, otherwise you will see a warning and the message [!UICONTROL Invalid formula expression]. 
